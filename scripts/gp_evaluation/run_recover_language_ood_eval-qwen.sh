...
k_top=4096
k_tail=0
CKPT_NAME="/path/checkpoint-1500-restored-direction--4096--0"
OUTPUT_FOLDER="logs/gp_l_ood_recover_verify_${VITER}_target_${TARGET}_${today}_${check_point}_${k_top}_${k_tail}"
...
echo "Cleaning PyTorch extension cache..."
...
accelerate launch  \
    ...
    --env_config.ood=${OOD} \
    --num_traj=${NUM_TRAJ} \
 2>&1 | tee eval-ood-recover-dir-qwen-1500-tamia-${today}-ck${check_point}-${k_top}-${k_tail}.log
